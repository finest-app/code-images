  ...
  tailwind: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        highlight: chroma("rgba(25,147,211,0.10)").hex(),
        highlightHover: chroma("rgba(25,147,211,0.06)").hex(),
      }),
      dark: convertToShikiTheme({
        foreground: "#fff",
        highlightBorder: "#C1B2F9",
        highlight: chroma("rgba(193,178,249,0.12)").hex(),
        highlightHover: chroma("rgba(193,178,249,0.07)").hex(),
      }),
    },
  },
  openai: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        number: "#e9950c",
        property: "#F22C3D",
        highlight: chroma("rgba(0,0,0,0.02)").hex(),
        highlightHover: chroma("rgba(0,0,0,0.015)").hex(),
      }),
      dark: convertToShikiTheme({
        foreground: "#fff",
        constant: "#df3079",
        string: "#fff",
        comment: chroma("rgba(255,255,255,0.4)").hex(),
        keyword: "#2E95D3",
        parameter: "#fff",
        function: "#00A67D",
        stringExpression: "#00A67D",
        ...
        number: " #e9950c",
        property: "#F22C3D",
        highlight: chroma("rgba(255, 255, 255, 0.05)").hex(),
        highlightHover: chroma("rgba(255, 255, 255, 0.03)").hex(),
      }),
    },
  },
  mintlify: {
    ...
    syntax: {
      ...
      dark: convertToShikiTheme({
        ...
        number: "#b5cea8",
        property: "#b5cea8",
        highlight: chroma("rgb(131 114 55 / 30%)").hex(),
        highlightHover: chroma("rgb(131 114 55 / 15%)").hex(),
  ...
  ice: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        number: "#00B0E9",
        property: "#00B0E9",
        highlight: chroma("rgba(0,167,219,0.1)").hex(),
        highlightBorder: "#00B0E9",
        highlightHover: chroma("rgba(0,167,219,0.05)").hex(),
      }),
      dark: convertToShikiTheme({
        foreground: "#FFFFFF",
        constant: "#92DEF6",
        ...
        number: "#00B0E9",
        property: "#00B0E9",
        highlight: chroma("rgba(146,222,246,0.14)").hex(),
        highlightBorder: "#92DEF6",
        highlightHover: chroma("rgba(146,222,246,0.09)").hex(),
      }),
    },
  },
  sand: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        number: "#A28C4E",
        property: "#A28C4E",
        highlight: chroma("rgba(218,135,68,0.1)").hex(),
        highlightBorder: "#DA8744",
        highlightHover: chroma("rgba(218,135,68,0.05)").hex(),
      }),
      dark: convertToShikiTheme({
        foreground: "#FFFFFF",
        constant: "#C2B181",
        ...
        number: "#C2B181",
        property: "#C2B181",
        highlight: chroma("rgba(244,163,97,0.14)").hex(),
        highlightBorder: "#F4A361",
        highlightHover: chroma("rgba(244,163,97,0.09)").hex(),
      }),
    },
  },
  forest: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        number: "#78876E",
        property: "#2E382F",
        highlight: chroma("rgba(75,148,66,0.12)").hex(),
        highlightBorder: "#4B9442",
        highlightHover: chroma("rgba(75,148,66,0.07)").hex(),
      }),
      dark: convertToShikiTheme({
        foreground: "#FFFFFF",
        constant: "#6B8F71",
        ...
        number: "#AAB4A3",
        property: "#C9C7BC",
        highlight: chroma("rgba(170,180,163,0.14)").hex(),
        highlightBorder: "#6B8F71",
        highlightHover: chroma("rgba(170,180,163,0.09)").hex(),
      }),
    },
  },
  mono: {
...
const themeAtom = atomWithHash<Theme>(
  ...
  (() => {
    if (typeof window !== "undefined") {
      ...
      const codeTheme = window.utools
        ? window.utools.dbStorage.getItem("codeTheme")
  ...
  })(),
  {
    ...
    deserialize(key) {
      if (key && key in THEMES) {
        window.utools ? window.utools.dbStorage.setItem("codeTheme", key) : localStorage.setItem("codeTheme", key);
